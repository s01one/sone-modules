...
use SequelONE\sOne\Modules\Activators\FileActivator;
...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path' => base_path('vendor/SequelONE/laravel-modules/src/Commands/stubs'),
        'files' => [
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'SequelONE'),
        'author' => [
