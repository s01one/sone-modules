...
use SequelONE\sOne\Modules\Exceptions\InvalidJLaravelxception;
...
class Json
{
     ...
     * @return array
     *
     * @throws InvalidJLaravelxception
     */
    public function decodeContents()
    {
        ...
        if (json_last_error() > 0) {
            throw new InvalidJLaravelxception('Error processing file: '.$this->getPath().'. Error: '.json_last_error_msg());
        }
