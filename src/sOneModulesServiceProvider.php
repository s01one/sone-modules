...
use SequelONE\sOne\Modules\Exceptions\InvalidActivatorClass;
use SequelONE\sOne\Modules\Support\Stub;
use Symfony\Component\Console\Output\NullOutput;

class sOneModulesServiceProvider extends ModulesServiceProvider
{
    /**
     * Booting the package.
     */
    public function boot()
    {
        ...
        AboutCommand::add('sone-modules', [
            'Version' => fn () => InstalledVersions::getPrettyVersion('sequelone/sone-modules'),
        ]);
    }
    ...
    protected function registerMigrations(): void
    {
        ...
        $this->app->resolving(Migrator::class, function (Migrator $migrator) {
            ...
            collect(\SequelONE\sOne\Modules\Facades\Module::allEnabled())
                ->each(function (\SequelONE\sOne\Modules\Laravel\Module $module) use ($migration_path, $migrator) {
    ...
    protected function registerTranslations(): void
    {
        ...
        $this->callAfterResolving('translator', function (TranslatorContract $translator) {
            ...
            collect(\SequelONE\sOne\Modules\Facades\Module::allEnabled())
                ->each(function (\SequelONE\sOne\Modules\Laravel\Module $module) use ($translator) {
