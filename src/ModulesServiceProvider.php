...
use SequelONE\sOne\Modules\Providers\ConsoleServiceProvider;
use SequelONE\sOne\Modules\Providers\ContractsServiceProvider;
...
abstract class ModulesServiceProvider extends ServiceProvider
{
    ...
    {
        // $this->app->register(\SequelONE\sOne\Modules\Providers\BootstrapServiceProvider::class);
    ...
    protected function registerNamespaces()
    {
        ...
        $this->publishes([
            $stubsPath => base_path('stubs/SequelONE-stubs'),
        ], 'stubs');
