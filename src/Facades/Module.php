...
namespace SequelONE\sOne\Modules\Facades;
 ...
 * @method static \SequelONE\sOne\Modules\Collection toCollection()
 ...
 * @method static \SequelONE\sOne\Modules\Module find(string $name)
 * @method static \SequelONE\sOne\Modules\Module findOrFail(string $name)
